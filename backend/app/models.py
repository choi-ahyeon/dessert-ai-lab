...
class Fruit(Base):
    ...
    sweetness_score = Column(SmallInteger, nullable=True)
    acidity_score = Column(SmallInteger, nullable=True)
    bitterness_score = Column(SmallInteger, nullable=True)
    creaminess_score = Column(SmallInteger, nullable=True)
    juiciness_score = Column(SmallInteger, nullable=True)
    richness_score = Column(SmallInteger, nullable=True)
    freshness_score = Column(SmallInteger, nullable=True)
    vector_verified = Column(Boolean, default=False)
...
class Combination(Base):
    ...
    predicted_sweetness = Column(Numeric, nullable=True)
    predicted_acidity = Column(Numeric, nullable=True)
    predicted_bitterness = Column(Numeric, nullable=True)
    predicted_creaminess = Column(Numeric, nullable=True)
    predicted_juiciness = Column(Numeric, nullable=True)
    predicted_richness = Column(Numeric, nullable=True)
    predicted_freshness = Column(Numeric, nullable=True)
    ratio_a = Column(Numeric, default=0.5)
    ratio_b = Column(Numeric, default=0.5)
    created_at = Column(DateTime(timezone=True), nullable=True)
